...
function map_selected() {
    if (download_records.length) {
        ...
        $('div.results-toolbar').html('<button type="button" class="view-all btn btn-primary btn-xs">view all</button><button type="button" class="download-records record-btns btn btn-primary btn-xs">download selected</button><span id="download-help" class="nav-item" data-modal="help-modal"><i class="glyphicon glyphicon-question-sign"></i>&nbsp;&nbsp;download help</span>');
        $('.filter-btn').prop('disabled', true);
    } else {
