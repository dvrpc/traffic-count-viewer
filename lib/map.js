...
var table_rows = Math.floor((win_height - 281)/35);
...
var column_options = [
    ...
    { "data": "date", "title": "Date", "width": "12%", "className": "table-date"},
    { "data": "tableRoad", "title": "Road", "width": "46%", "className": "max-char" },
    { "data": "type", "title": "Type", "width": "20%", "className": "table-type"},
    { "data": "aadt", "title": "AADT*", "width": "9%", "type": "num-fmt-nan" },
    { "data": "report","title":"File No.", "width": "12%", "className": "select-report"},
...
$(document.body).on('mouseover', '#table tbody td', function () {
    if (tableExists && (TCtable.length > 0)) {
