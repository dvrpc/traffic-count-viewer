...
$(document).on('click', '.download-records', function(e) {
    var count_request = '<a type="button" id="download-1" class="download-request btn btn-primary btn-md" href="http://www.dvrpc.org/asp/trafficCount/download.aspx?recnum=';
    for (var i = 0, len = download_records.length; i < len; i++){
