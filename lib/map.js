...
$("#yearSlider").noUiSlider_pips({
    mode: 'steps',
    filter: filterdates,
    density: density

});
var formatNumbers = wNumb({
    decimals: 0
});
$("#yearSlider").Link('lower').to($("#yearMin"),'text',formatNumbers);
$("#yearSlider").Link('upper').to($("#yearMax"),'text',formatNumbers);
