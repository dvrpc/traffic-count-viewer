        ...
        if (feature.properties) {
            ...
            layer.on({
                ...
                click: function(e){
                    if (TCtable.length > 0) {
                        proximity_sort = true; 
                        centerLatLng = this.getLatLng();//.latlng; //store as global
...
var column_options = [
    ...
    { "data": "aadt", "title": "AADT*", "width": "11%", "sType": "intcomma" },
...
jQuery.fn.dataTableExt.oSort['intcomma-asc'] = function(a, b) {
...
jQuery.fn.dataTableExt.oSort['intcomma-desc'] = function(a, b) {
    a = parseInt(a.replace(/,/g, ""));
    b = parseInt(b.replace(/,/g, ""));
    if (isNaN(a)) { a = 0 };
    if (isNaN(b)) { b = 0 };
