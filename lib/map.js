...
function createMap() {
    ...
    L.Control.MapLegend = L.Control.extend({
        ...
        onAdd: function (map) {
            ...
            var legendDiv = L.DomUtil.create('div', 'legend-control leaflet-bar');

            var legend_top       = L.DomUtil.create('div', 'legend legend-top', legendDiv),
                legend_body     = L.DomUtil.create('div', 'legend legend-body', legendDiv),
                legend_bottom     = L.DomUtil.create('div', 'legend legend-bottom', legendDiv);
