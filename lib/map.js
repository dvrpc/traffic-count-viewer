...
var tableExists = false, download_records=[], TCtable=[], proximity_sort = false ;  
...
// ****************************************
// define leaflet layer for selected records
...
function build_table(results){
    ...
    results.eachLayer(function(m){
        ...
        TCtable.push({"date":MmYear,"road":road,"type":capitalize(type),"aadt":aadt_form,"cntdir":cntdir,"unid": unique, "layer":layer,"recnum":recnum, "report":report,"latlng":latlng});
    });
