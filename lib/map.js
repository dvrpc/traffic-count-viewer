...
//build functionality for various report types
    if(typ === "" || typ === "" || typ === ""){
        //trigger the loading of a link that displays pdf report in browser
        window.open('http://www.dvrpc.org/asp/trafficCount/default.aspx?recnum='+ dr, '_blank');
    }else{
        //tell the user that this report must be accessed by contacting dvrpc or load the DAMN REPORTS to the web
