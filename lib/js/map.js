...
function createMap() {
    ...
    county = L.esri.featureLayer({
        url: 'https://services1.arcgis.com/LWtWv6q6BJyKidj8/ArcGIS/rest/services/DVRPC_Boundaries/FeatureServer/1',
        simplifyFactor: 0.5,
        precision: 5,
        style: {
            color: 'grey',
...
function search_by_number() {
    ...
    L.esri.Tasks.query({
            url: 'https://services1.arcgis.com/LWtWv6q6BJyKidj8/ArcGIS/rest/services/DVRPC_Traffic_Count_App_Service/FeatureServer/0'
        })
        .where(criteria)
...
function get_query_url(layer) {
    switch (layer) {
        ...
        case 'mun_boundary':
            return 'https://services1.arcgis.com/LWtWv6q6BJyKidj8/ArcGIS/rest/services/DVRPC_Boundaries/FeatureServer/0';
        case 'neighborhood':
