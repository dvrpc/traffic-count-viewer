    ...
    onEachFeature: function(feature, layer) {
        if (feature.properties) {
            ...
            layer.on({
                ...
                // @UPDATE: feature point click handler is here
                // @UPDATE what?
                click: function(e) {
                    console.log('clicked feature point ', e)
                    
                    // fetch_report_data(e.features[0].recordNum)
            ...
            layer.on({
                ...
                click: function(e) {
                    ...
                    if(makeCircle) {
                        ...
                        map._layers[props.recordnum].setStyle({
                            weight: 3,
                            radius: 10,
                            fillOpacity: 1.0
                        });
...
// @UPDATE: copying this bit of code into circle click
