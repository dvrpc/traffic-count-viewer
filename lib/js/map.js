...
function get_query_url(layer) {
    switch (layer) {
        case 'zip':
            return 'https://services.arcgis.com/P3ePLMYs2RVChkJx/arcgis/rest/services/USA_ZIP_Codes_2015/FeatureServer/0';
        case 'mun_boundary':
            return 'https://arcgis.dvrpc.org/portal/rest/services/Boundaries/MunicipalBoundaries/FeatureServer/0';
        case 'neighborhood':
            return 'https://services.arcgis.com/rkitYk91zieQFZov/ArcGIS/rest/services/Philadelphia_Neighborhoods/FeatureServer/0';
    }
}
...
$(document).on('click', '.download-records', function(e) {
    ...
    var btn_template = '<a type="button" data-loading-text="Downloading..." class="download-request btn btn-primary btn-md" href="https://www.dvrpc.org/asp/trafficCount/download.aspx?recnum=';
