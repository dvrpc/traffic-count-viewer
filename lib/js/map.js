...
// @UPDATE: new API can go here ?
    // https://cloud.dvrpc.org/api/traffic-counts/v1/docs
var query_sources = {
    'zip': {
        key: 'ZIP_CODE',
...
// @UPDATE: replace "record_report" invocation w/new template fnc
