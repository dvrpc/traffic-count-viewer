...
function make_report_table_content(counts) {
  ...
  counts.forEach((count) => {
    ...
    midnightTd.textContent = count.AM12 || '';
    oneamTd.textContent = count.AM1 || '';
    twoamTd.textContent = count.AM2 || '';
    threeamTd.textContent = count.AM3 || '';
    fouramTd.textContent = count.AM4 || '';
    fiveamTd.textContent = count.AM5 || '';
    sixamTd.textContent = count.AM6 || '';
    sevenamTd.textContent = count.AM7 || '';
    eightamTd.textContent = count.AM8 || '';
    nineamTd.textContent = count.AM9 || '';
    tenamTd.textContent = count.AM10 || '';
    elevenamTd.textContent = count.AM11 || '';
    noonTd.textContent = count.PM12 || '';
    onepmTd.textContent = count.PM1 || '';
    twopmTd.textContent = count.PM2 || '';
    threepmTd.textContent = count.PM3 || '';
    fourpmTd.textContent = count.PM4 || '';
    fivepmTd.textContent = count.PM5 || '';
    sixpmTd.textContent = count.PM6 || '';
    sevenpmTd.textContent = count.PM7 || '';
    eightpmTd.textContent = count.PM8 || '';
    ninepmTd.textContent = count.PM9 || '';
    tenpmTd.textContent = count.PM10 || '';
    elevenpmTd.textContent = count.PM11 || '';
