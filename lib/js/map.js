...
function createMap() {
    ...
    county = L.esri.featureLayer({
        url: 'https://arcgis.dvrpc.org/portal/rest/services/Boundaries/CountyBoundaries/FeatureServer/1',
        simplifyFactor: 0.5,
        precision: 5,
        style: {
            color: 'grey',
...
function get_query_url(layer) {
    switch (layer) {
        ...
        case 'mun_boundary':
            return 'https://arcgis.dvrpc.org/portal/rest/services/Boundaries/CountyBoundaries/FeatureServer/0';
        case 'neighborhood':
